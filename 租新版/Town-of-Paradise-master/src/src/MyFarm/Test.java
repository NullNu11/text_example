...
import MyFarm.farmland.FlyweightFactory;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        MyFarm.Iterator.IteratorPatternDemo.PrintProducts();
        //测试空对象模式
        System.out.println();
        System.out.println("=====现在开始测试空对象模式：=====");
        MyFarm.NullObject.NullPatternDemo.FindProducts(args);
        ...
        BaseLand landx = FlyweightFactory.getFlyweight("黄土地");
        BaseLand landy = FlyweightFactory.getFlyweight("黑土地");
        BaseLand landz = FlyweightFactory.getFlyweight("黄土地");
        ...
        BaseLand land;
        land = new BuildingLand((float) 1.0);
        land.plant(new Dog());
        land.showCrop();
